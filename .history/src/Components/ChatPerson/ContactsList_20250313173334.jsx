...
const ContactsList = ({ onContactSelect, currentUser, isOpen, toggleContacts }) => {
  ...
  const handleContactSelect = (contact) => {
    ...
    onContactSelect(contact); // This will hide ContactsList and show ChatWindow
  };
  ...
  return (
    <>
      <button
        ...
        style={{ display: isOpen ? "none" : "flex" }} // Visible when ContactsList is hidden
      >
