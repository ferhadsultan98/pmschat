...
import { database, ref, onValue, getAuth } from "../../Server/Firebase";
import { getAuth } from "../../Server/Firebase"; 
...
const ContactsList = ({ onContactSelect }) => {
  ...
  useEffect(() => {
    ...
    const auth = getAuth(); // Firebase Authentication'dan auth nesnesini al
