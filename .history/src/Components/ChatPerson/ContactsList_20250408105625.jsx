...
const ContactsList = ({ onContactSelect, currentUser, isOpen }) => {
    ...
    const unsubscribe = onValue(
      ...
      async (snapshot) => {
        ...
        const contactsWithLastMessage = Array.from(chatUserIds).map(userId => {
          ...
          // Get the last message directly from chat data
          ...
          if (chatData) {
            ...
            // If chat doesn't have a lastMessageTimestamp field yet, try to get from the latest message
  ...
  const handleContactSelect = (contact) => {
    ...
    onContactSelect({
      ...contact,
      chatId: contact.chatId, // Pass chatId to parent component
    });
  };
