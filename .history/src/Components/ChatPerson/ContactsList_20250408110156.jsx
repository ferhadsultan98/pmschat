...
const ContactsList = ({ onContactSelect, currentUser, isOpen }) => {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onValue(chatsRef, async (snapshot) => {
      ...
      contactsWithLastMessage.sort((a, b) => (b.timestamp || 0) - (a.timestamp || 0));
  ...
  const handleSearch = (query) => setLocalSearchQuery(query);
    ...
    <div className={`contactsList ${isOpen ? "isOpen" : ""}`}>
      ...
      <div className="contactsContainer">
        {filteredContacts.length > 0 ? (
          ...
          <div className="noChatsMessage">No chats found. Start a new conversation!</div>
        )}
      </div>
