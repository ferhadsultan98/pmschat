...
const handleLoginSubmit = async (e) => {
  ...
  try {
    ...
    if (snapshot.exists()) {
      ...
      console.log("Users from Firebase:", users); // Debugging: Check the data structure
      ...
      if (userFound) {
        ...
        console.log("User found:", userData); // Debugging: Confirm user data
        ...
        toast.success("Login successful! Redirecting...", {
          position: "top-right",
          autoClose: 2000,
          onClose: () => navigate("/chat"), // Navigate after toast closes
        });
      } else {
