...
const ChatWindow = () => {
  ...
  const [showFileModal, setShowFileModal] = useState(false); // FileModal state'i eklendi
  const messageEndRef = useRef(null);

  // Placeholder: Normalde contact buraya bir context veya üst bileşenden gelmeli
  const contact = null; // Bu kısmı bir context ile çözmek gerekebilir
      ...
      <form className="chatInputContainer" onSubmit={handleSendMessage}>
        <div className="chatMessageActions">
          ...
          <button
            ...
            onClick={() => setShowFileModal(true)} // FileModal'ı aç
          >
            <Paperclip size={24} />
          </button>
        </div>
