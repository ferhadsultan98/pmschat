...
const ChatWindow = ({ contact, currentUser, isOpen, toggleWindow }) => {
  ...
  const handleSendMessage = (e) => {
    ...
    // Timestamp for consistency across updates
    ...
    push(messagesRef, newMessage)
      .then(() => {
        ...
        // Update the chat record itself
        update(chatRef, chatUpdate);
        
        // Also update participants if needed
        const participantsUpdate = {};
        participantsUpdate[`participants/${currentUser.userId}`] = true;
        participantsUpdate[`participants/${contact.id}`] = true;
        update(chatRef, participantsUpdate);
