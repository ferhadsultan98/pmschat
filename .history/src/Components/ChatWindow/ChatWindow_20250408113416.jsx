...
const ChatWindow = ({ contact, currentUser, isOpen, toggleWindow }) => {
  ...
  const scrollToBottom = () => {
    ...
    if (container) {
      container.scrollTop = container.scrollHeight; // Instant scroll to bottom
    }
  };

  // Fetch messages and scroll to bottom when contact changes or messages update
  useEffect(() => {
    ...
    // Initial scroll to bottom when contact changes
