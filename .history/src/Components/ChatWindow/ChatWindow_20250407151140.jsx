...
const ChatWindow = ({ contact, currentUser, isOpen, toggleWindow }) => {
  ...
  const handleClickOutside = (event) => {
    const dropdown = document.querySelector(`#dropdown-${openDropdownId}`); // Dropdown'unuzun ID'sine göre ayarlayın
    if (dropdown && !dropdown.contains(event.target) && openDropdownId !== null) {
