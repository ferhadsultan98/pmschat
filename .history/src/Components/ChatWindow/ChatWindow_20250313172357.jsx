...
import { IoIosArrowBack } from "react-icons/io"; // Added import for IoIosArrowBack
    ...
    <div className="chatWindow">
      <div className="chatHeader">
        ...
        <div className="chatContactInfo">
           <div 
            className="backChat"
            onClick={toggleWindow} // Fixed: Added as a proper attribute
            style={{ display: isOpen ? "none" : "flex" }} // Fixed: Added as a proper attribute
           >
             <IoIosArrowBack size={20}/> {/* Fixed: Properly nested */}
           </div>
