...
import { getDatabase, ref, onValue, push, serverTimestamp, update, get, remove, set, getAuth } from "firebase/database";
...
export { database, ref, onValue, push, serverTimestamp, update, get, remove, set, getAuth };