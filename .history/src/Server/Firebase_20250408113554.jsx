...
import { getDatabase, ref, onValue, push, serverTimestamp, update, get, remove, set, query, orderByChild, equalTo } from "firebase/database";
...
export { database, ref, onValue, push, serverTimestamp, update, get, remove, set, query, orderByChild, equalTo };