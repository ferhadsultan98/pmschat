...
import { getDatabase, ref, onValue, push, serverTimestamp, update, get, remove, set, auth } from "firebase/database";
...
export { database, ref, onValue, push, serverTimestamp, update, get, remove, set, auth };